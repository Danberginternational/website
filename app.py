...
RECEIVER_EMAIL = os.environ.get('RECEIVER_EMAIL', 'customersupport@danberginternational.com')
...
def contact():
    if request.method == 'POST':
        ...
        if name and email and message:
            body = f"Contact form - Danberg International\n\nName: {name}\nEmail: {email}\nCompany: {company or '(not provided)'}\n\nMessage:\n{message}"
            _send_email("Contact form - Danberg International", body)
...
def submit_consultation():
    ...
    _send_email("New consultation request - Danberg International", body)
...
def subscribe_newsletter():
    ...
    _send_email("Newsletter signup - Danberg International", f"New newsletter subscriber:\n\nEmail: {email}")
    sep = '&' if '?' in next_path else '?'
