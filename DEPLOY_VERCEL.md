# Deploy Danberg International website to Vercel
...
1. Create a repository on [GitHub](https://github.com/new) (e.g. `danberg-international-website`).
...
| `RECEIVER_EMAIL` | `customersupport@danberginternational.com` | Where forms are sent  |
...
2. Open it and test:
   ...
   - **Consultation form** (e.g. on Home or Services): submit and check that an email arrives at `customersupport@danberginternational.com`.
...
2. Add your domain (e.g. `danberginternational.com` or `www.danberginternational.com`).
