"""
Static blog data for Danberg International website.
"""
BLOGS = [
    {
        'slug': 'why-your-business-needs-digital-marketing',
        'title': 'Why Your Business Needs Digital Marketing in 2025',
        'excerpt': 'Discover how digital marketing can transform your business reach and ROI in the modern marketplace.',
        'author': 'Danberg International Team',
        'date': '2025-02-20',
        'read_time': '5 min read',
        'category': 'Digital Marketing',
        'image': 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>In today's fast-paced world, having an online presence isn't optional—it's essential. Digital marketing allows businesses to reach customers where they spend most of their time: online.</p>
        ...
        <p>At Danberg International, we combine data-driven insights with creative execution to deliver campaigns that resonate and convert.</p>
        '''
    },
    {
        'slug': 'custom-software-vs-off-the-shelf',
        'title': 'Custom Software vs Off-the-Shelf: Making the Right Choice',
        'excerpt': 'We break down when to invest in custom solutions and when ready-made software makes more sense.',
        'author': 'Danberg International Team',
        'date': '2025-02-18',
        'read_time': '6 min read',
        'category': 'Software',
        'image': 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>Choosing between custom software and off-the-shelf products depends on your business needs, budget, and long-term goals. Off-the-shelf solutions work well for common workflows, but they often come with limitations and recurring licensing costs.</p>
    ...
    },
    {
        ...
        'excerpt': "Practical SEO strategies that don't require a huge budget but deliver real results.",
        'author': 'Danberg International Team',
        'date': '2025-02-15',
        ...
        'content': '''
        <p>Search engine optimization doesn't have to be complicated or expensive. Start with the basics: a fast, mobile-friendly website, clear page titles and meta descriptions, and quality content that answers your audience's questions.</p>
    ...
    },
    {
        ...
        'excerpt': 'Architecture and practices that let your web app grow without costly rewrites.',
        'author': 'Danberg International Team',
        'date': '2025-02-12',
        'read_time': '7 min read',
        'category': 'Software',
        'image': 'https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>Scalability isn't something you add later—it's something you design for from the start. Choosing the right stack, database design, and deployment strategy can save you from painful migrations down the road.</p>
    ...
    },
    {
        ...
        'excerpt': 'Move beyond likes and shares—learn how to turn social presence into leads and sales.',
        'author': 'Danberg International Team',
        'date': '2025-02-10',
        'read_time': '5 min read',
        'category': 'Digital Marketing',
        'image': 'https://images.unsplash.com/photo-1611606063065-ee7946f0787a?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>Social media is more than posting and hoping for engagement. A conversion-focused strategy starts with knowing your audience, choosing the right platforms, and creating content that moves people along the funnel.</p>
    ...
    },
    {
        ...
        'excerpt': 'Why designing for mobile first leads to better experiences and better business outcomes.',
        'author': 'Danberg International Team',
        'date': '2025-02-08',
        'read_time': '4 min read',
        'category': 'Design',
        'image': 'https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>Most users now access the web from their phones. Mobile-first design means starting with the smallest screen and progressively enhancing for larger ones—resulting in faster, cleaner experiences everywhere.</p>
    ...
    },
    {
        ...
        'excerpt': 'How to use analytics and testing to improve your marketing performance.',
        'author': 'Danberg International Team',
        'date': '2025-02-05',
        'read_time': '6 min read',
        'category': 'Digital Marketing',
        'image': 'https://images.unsplash.com/photo-1517142089942-ba376ce32a2e?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>Gut feeling has its place, but sustainable growth comes from data. Set up proper tracking—Google Analytics, conversion goals, and attribution—so you know what's actually working.</p>
    ...
    },
    {
        ...
        'excerpt': 'Secure, reliable ways to connect your apps, CRMs, and third-party services.',
        'author': 'Danberg International Team',
        'date': '2025-02-02',
        'read_time': '5 min read',
        'category': 'Software',
        'image': 'https://images.unsplash.com/photo-1516251193007-45ef944ab0c6?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>APIs power modern business—connecting your website, CRM, payment gateways, and internal tools. Doing it right means consistent error handling, retries, and clear documentation.</p>
    ...
    },
    {
        ...
        'excerpt': 'How to craft and share your brand story across channels for lasting impact.',
        'author': 'Danberg International Team',
        'date': '2025-01-28',
        'read_time': '5 min read',
        'category': 'Digital Marketing',
        'image': 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=960&q=80',
        'content': '''
        <p>People don't just buy products—they buy into stories and values. Your brand story should be clear, consistent, and present everywhere: your website, social feeds, ads, and support interactions.</p>
